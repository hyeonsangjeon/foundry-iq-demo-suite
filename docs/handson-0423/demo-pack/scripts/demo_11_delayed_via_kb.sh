#!/usr/bin/env bash
# demo_11_delayed_via_kb.sh — Layer 2 path mirror of demo_06_delayed.sh.
...
echo ""
echo "═══════════════════════════════════════════════════════════════════"
echo "  Demo 11 — Layer 2: operational signal via Foundry IQ KS"
echo "═══════════════════════════════════════════════════════════════════"
echo ""
echo "Filtered query (Signal). Mirrors Demo 6 — expect 42 delayed flights."
echo "Same Signal can be paired with a Foundry IQ searchIndex KS hit on"
echo "DOT passenger-rights PDFs to produce a Signal-to-Outcome answer."
echo ""
echo "Query: ${QUERY}"
echo ""
...
echo ""
echo "═══════════════════════════════════════════════════════════════════"
echo "  ✅ Same 42 delayed flights — different path (Signal layer)"
echo "═══════════════════════════════════════════════════════════════════"
