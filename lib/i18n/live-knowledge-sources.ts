...
export const liveKnowledgeSourcesI18n: Record<Locale, LiveKnowledgeSourcesCopy> = {
  en: {
    ...
    description:
      'This app demonstrates the experience and response contract. Use Microsoft\'s official repository for deployment scripts, notebooks, REST samples, mcp-only / byo-fabric / full modes, combined Knowledge Base routing, and current public-preview limits.',
    facts: [
    ...
    officialRepo: 'Open official repo',
    mcpGuide: 'MCP setup',
  ...
  ko: {
    ...
    description:
      '이 앱은 사용자 경험과 응답 구조를 보여주는 데모입니다. 실제 배포 스크립트, 노트북, REST 샘플, mcp-only / byo-fabric / full 모드, 통합 Knowledge Base 라우팅, 최신 공개 미리 보기 제약은 Microsoft 공식 저장소에서 확인하세요.',
    facts: [
  ...
  zh: {
    ...
    description:
      '本应用用于演示交互体验和响应契约。部署脚本、笔记本、REST 示例、mcp-only / byo-fabric / full 模式、组合知识库路由以及最新公共预览限制，请参阅 Microsoft 官方存储库。',
    facts: [
      { label: '部署模式', value: 'mcp-only · byo-fabric · full' },
      { label: '检查证据', value: 'activity · references · sourceData' },
      { label: '快速评估', value: '30 秒离线回放' },
    ],
    officialRepo: '打开官方存储库',
    mcpGuide: 'MCP 设置',
  ...
  ja: {
    ...
    description:
      'このアプリは操作体験とレスポンス契約を示すデモです。展開スクリプト、ノートブック、REST サンプル、mcp-only / byo-fabric / full モード、統合 Knowledge Base ルーティング、最新のパブリックプレビュー制限は Microsoft 公式リポジトリを参照してください。',
    facts: [
  ...
  hi: {
    ...
    description:
      'यह ऐप अनुभव और प्रतिक्रिया अनुबंध का डेमो है। तैनाती स्क्रिप्ट, नोटबुक, REST नमूने, mcp-only / byo-fabric / full मोड, संयुक्त Knowledge Base रूटिंग और नवीनतम सार्वजनिक पूर्वावलोकन सीमाओं के लिए Microsoft का आधिकारिक रिपॉज़िटरी देखें।',
    facts: [
    ...
    officialRepo: 'आधिकारिक रिपॉज़िटरी खोलें',
    mcpGuide: 'MCP सेटअप',
